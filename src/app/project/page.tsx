...
export default function BuilderDashboard() {
  ...
  const [customerData, setCustomerData] = useState({
    builderId: '', projectId: '', firstName: '', lastName: '', email: '', phone: '', floor: '', towerName: '', flatName: '', areaSqft: ''
  });
  ...
  const handleCustomerSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      setSuccess(true);
      setCustomerData({ builderId: customerData.builderId, projectId: '', firstName: '', lastName: '', email: '', phone: '', floor: '', towerName: '', flatName: '', areaSqft: '' });
      fetchCustomers();
              ...
              <div className="p-8 overflow-y-auto bg-white">
                ...
                {!success && (
                  <form onSubmit={handleProjectSubmit} className="space-y-6">
                    <div className="grid sm:grid-cols-2 gap-6">
                      <div className="sm:col-span-2">
                        <label className="block text-xs font-bold text-slate-500 mb-2 uppercase tracking-widest">Assign to Customer (Optional)</label>
                        <div className="relative">
                          <select 
