    ...
    <div className="min-h-screen bg-[#F8F9FA] text-slate-900 p-8 font-sans">
      <div className="max-w-7xl mx-auto space-y-6">
        ...
        <div className="flex flex-col sm:flex-row sm:items-start justify-between gap-4">
          <div>
            <h1 className="text-3xl font-extrabold text-[#0F172A] tracking-tight">{project?.project_name}</h1>
            <p className="text-sm font-medium text-slate-400 mt-1">{project?.location}</p>
          </div>
          <button onClick={() => setShowAddTower(true)} className="inline-flex items-center justify-center px-6 py-2.5 bg-[#0F172A] text-white text-sm font-semibold rounded-xl hover:bg-blue-600 transition-colors shadow-sm">
